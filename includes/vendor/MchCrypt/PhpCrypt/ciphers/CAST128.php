 ...
 */
class PhpCrypt_Cipher_CAST_128 extends PhpCrypt_Cipher
{
	...
	public function __construct($key)
	{
		...
		{
			$msg  = PhpCrypt::CIPHER_CAST_128." requires a key size between ";
			$msg .= "5 - 16 bytes.";
			trigger_error($msg, E_USER_WARNING);
		}

		// set the key, make sure the required length is set in bytes
		parent::__construct(PhpCrypt::CIPHER_CAST_128, $key, $keylen);
