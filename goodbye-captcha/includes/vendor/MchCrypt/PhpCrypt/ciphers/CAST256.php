 ...
 */
class PhpCrypt_Cipher_CAST_256 extends PhpCrypt_Cipher
{
	...
	public function __construct($key)
	{
		...
		{
			$msg  = PhpCrypt::CIPHER_CAST_256." requires a key size of 16, ";
			$msg .= "20, 24, 28, or 32 bytes.";
			trigger_error($msg, E_USER_WARNING);
		}

		// set the key, make sure the required length is set in bytes
		parent::__construct(PhpCrypt::CIPHER_CAST_256, $key, $keylen);
